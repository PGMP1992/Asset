...
namespace Asset.Migrations
{
    ...
    [Migration("20240406112436_MyAssetProductCountry")]
    partial class MyAssetProductCountry
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("Asset.MyAsset", b =>
                {
                    b.HasOne("Asset.Country", "Country")
                        .WithOne("MyAsset")
                        .HasForeignKey("Asset.MyAsset", "CountryId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("Asset.Product", "Product")
                        .WithOne("MyAsset")
                        .HasForeignKey("Asset.MyAsset", "ProductId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
